...
| [aws_security_group_rule.allow_bbe_egress_to_bichard](https://registry.terraform.io/providers/hashicorp/aws/3.75.2/docs/resources/security_group_rule) | resource |
| [aws_security_group_rule.allow_bbe_egress_to_bichard_backend](https://registry.terraform.io/providers/hashicorp/aws/3.75.2/docs/resources/security_group_rule) | resource |
...
| [aws_security_group_rule.allow_bichard_backend_bbe_ingress](https://registry.terraform.io/providers/hashicorp/aws/3.75.2/docs/resources/security_group_rule) | resource |
| [aws_security_group_rule.allow_bichard_bbe_ingress](https://registry.terraform.io/providers/hashicorp/aws/3.75.2/docs/resources/security_group_rule) | resource |
...
| [aws_security_group_rule.allow_opensearch_egress_from_logstash](https://registry.terraform.io/providers/hashicorp/aws/3.75.2/docs/resources/security_group_rule) | resource |
| [aws_security_group_rule.allow_opensearch_ingress_from_logstash](https://registry.terraform.io/providers/hashicorp/aws/3.75.2/docs/resources/security_group_rule) | resource |
...
| [template_file.allow_ssm_policy](https://registry.terraform.io/providers/hashicorp/template/2.2.0/docs/data-sources/file) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_admin_htaccess_password_arn"></a> [admin\_htaccess\_password\_arn](#input\_admin\_htaccess\_password\_arn) | prometheus password arn | `string` | n/a | yes |
| <a name="input_admin_htaccess_username"></a> [admin\_htaccess\_username](#input\_admin\_htaccess\_username) | prometheus username | `string` | n/a | yes |
| <a name="input_allowed_ingress_cidr"></a> [allowed\_ingress\_cidr](#input\_allowed\_ingress\_cidr) | An allowed list of ingress CIDRS in our vpc | `list(string)` | `[]` | no |
...
| <a name="input_bichard_alb_backend_id"></a> [bichard\_alb\_backend\_id](#input\_bichard\_alb\_backend\_id) | n/a | `string` | n/a | yes |
| <a name="input_bichard_alb_web_id"></a> [bichard\_alb\_web\_id](#input\_bichard\_alb\_web\_id) | n/a | `string` | n/a | yes |
...
| <a name="input_grafana_alb_security_group_id"></a> [grafana\_alb\_security\_group\_id](#input\_grafana\_alb\_security\_group\_id) | n/a | `string` | n/a | yes |
...
| <a name="input_grafana_db_security_group_id"></a> [grafana\_db\_security\_group\_id](#input\_grafana\_db\_security\_group\_id) | n/a | `string` | n/a | yes |
...
| <a name="input_grafana_security_group_id"></a> [grafana\_security\_group\_id](#input\_grafana\_security\_group\_id) | n/a | `string` | n/a | yes |
...
| <a name="input_kms_key_alert_notifications_arn"></a> [kms\_key\_alert\_notifications\_arn](#input\_kms\_key\_alert\_notifications\_arn) | n/a | `string` | n/a | yes |
...
| <a name="input_logstash_alb_security_group_id"></a> [logstash\_alb\_security\_group\_id](#input\_logstash\_alb\_security\_group\_id) | n/a | `string` | n/a | yes |
| <a name="input_logstash_ecs_task_def"></a> [logstash\_ecs\_task\_def](#input\_logstash\_ecs\_task\_def) | ecs task definition base encoded | `string` | n/a | yes |
| <a name="input_logstash_security_group_id"></a> [logstash\_security\_group\_id](#input\_logstash\_security\_group\_id) | n/a | `string` | n/a | yes |
| <a name="input_name"></a> [name](#input\_name) | The deployments name | `string` | n/a | yes |
| <a name="input_opensearch_security_group_id"></a> [opensearch\_security\_group\_id](#input\_opensearch\_security\_group\_id) | n/a | `string` | n/a | yes |
| <a name="input_os_username_arn"></a> [os\_username\_arn](#input\_os\_username\_arn) | opensearch username arn | `string` | n/a | yes |
...
| <a name="input_prometheus_alb_id"></a> [prometheus\_alb\_id](#input\_prometheus\_alb\_id) | n/a | `string` | n/a | yes |
| <a name="input_prometheus_alert_manager_alb_id"></a> [prometheus\_alert\_manager\_alb\_id](#input\_prometheus\_alert\_manager\_alb\_id) | n/a | `string` | n/a | yes |
| <a name="input_prometheus_blackbox_exporter_alb_id"></a> [prometheus\_blackbox\_exporter\_alb\_id](#input\_prometheus\_blackbox\_exporter\_alb\_id) | n/a | `string` | n/a | yes |
| <a name="input_prometheus_blackbox_exporter_ecs_task_def"></a> [prometheus\_blackbox\_exporter\_ecs\_task\_def](#input\_prometheus\_blackbox\_exporter\_ecs\_task\_def) | ecs task definition base encoded | `string` | n/a | yes |
| <a name="input_prometheus_blackbox_exporter_security_group_id"></a> [prometheus\_blackbox\_exporter\_security\_group\_id](#input\_prometheus\_blackbox\_exporter\_security\_group\_id) | n/a | `string` | n/a | yes |
| <a name="input_prometheus_cloudwatch_exporter_alb_id"></a> [prometheus\_cloudwatch\_exporter\_alb\_id](#input\_prometheus\_cloudwatch\_exporter\_alb\_id) | n/a | `string` | n/a | yes |
| <a name="input_prometheus_cloudwatch_exporter_ecs_task_def"></a> [prometheus\_cloudwatch\_exporter\_ecs\_task\_def](#input\_prometheus\_cloudwatch\_exporter\_ecs\_task\_def) | ecs task definition base encoded | `string` | n/a | yes |
...
| <a name="input_prometheus_ecs_task_def"></a> [prometheus\_ecs\_task\_def](#input\_prometheus\_ecs\_task\_def) | ecs task definition base encoded | `string` | n/a | yes |
...
| <a name="input_prometheus_exporter_security_group_id"></a> [prometheus\_exporter\_security\_group\_id](#input\_prometheus\_exporter\_security\_group\_id) | ## Security groups | `string` | n/a | yes |
...
| <a name="input_prometheus_security_group_id"></a> [prometheus\_security\_group\_id](#input\_prometheus\_security\_group\_id) | n/a | `string` | n/a | yes |
...
| <a name="input_sns_alert_notifications_arn"></a> [sns\_alert\_notifications\_arn](#input\_sns\_alert\_notifications\_arn) | n/a | `string` | n/a | yes |
...
| <a name="input_user_service_alb_id"></a> [user\_service\_alb\_id](#input\_user\_service\_alb\_id) | n/a | `string` | n/a | yes |
