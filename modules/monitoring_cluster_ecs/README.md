...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | -------------- | --------------------------- | :------: |
| <a name="input_admin_htaccess_password_arn"></a> [admin_htaccess_password_arn](#input_admin_htaccess_password_arn)                                                          | prometheus password arn                                               | `string`       | n/a                         |   yes    |
| <a name="input_admin_htaccess_username"></a> [admin_htaccess_username](#input_admin_htaccess_username)                                                                      | prometheus username                                                   | `string`       | n/a                         |   yes    |
| <a name="input_allowed_ingress_cidr"></a> [allowed_ingress_cidr](#input_allowed_ingress_cidr)                                                                               | An allowed list of ingress CIDRS in our vpc                           | `list(string)` | `[]`                        |    no    |
...
| <a name="input_bichard_alb_backend_id"></a> [bichard_alb_backend_id](#input_bichard_alb_backend_id)                                                                         | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_bichard_alb_web_id"></a> [bichard_alb_web_id](#input_bichard_alb_web_id)                                                                                     | n/a                                                                   | `string`       | n/a                         |   yes    |
...
| <a name="input_grafana_alb_security_group_id"></a> [grafana_alb_security_group_id](#input_grafana_alb_security_group_id)                                                    | n/a                                                                   | `string`       | n/a                         |   yes    |
...
| <a name="input_grafana_db_security_group_id"></a> [grafana_db_security_group_id](#input_grafana_db_security_group_id)                                                       | n/a                                                                   | `string`       | n/a                         |   yes    |
...
| <a name="input_grafana_security_group_id"></a> [grafana_security_group_id](#input_grafana_security_group_id)                                                                | n/a                                                                   | `string`       | n/a                         |   yes    |
...
| <a name="input_kms_key_alert_notifications_arn"></a> [kms_key_alert_notifications_arn](#input_kms_key_alert_notifications_arn)                                              | n/a                                                                   | `string`       | n/a                         |   yes    |
...
| <a name="input_logstash_alb_security_group_id"></a> [logstash_alb_security_group_id](#input_logstash_alb_security_group_id)                                                 | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_logstash_ecs_task_def"></a> [logstash_ecs_task_def](#input_logstash_ecs_task_def)                                                                            | ecs task definition base encoded                                      | `string`       | n/a                         |   yes    |
| <a name="input_logstash_security_group_id"></a> [logstash_security_group_id](#input_logstash_security_group_id)                                                             | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_name"></a> [name](#input_name)                                                                                                                               | The deployments name                                                  | `string`       | n/a                         |   yes    |
| <a name="input_opensearch_security_group_id"></a> [opensearch_security_group_id](#input_opensearch_security_group_id)                                                       | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_os_username_arn"></a> [os_username_arn](#input_os_username_arn)                                                                                              | opensearch username arn                                               | `string`       | n/a                         |   yes    |
...
| <a name="input_prometheus_alb_id"></a> [prometheus_alb_id](#input_prometheus_alb_id)                                                                                        | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_prometheus_alert_manager_alb_id"></a> [prometheus_alert_manager_alb_id](#input_prometheus_alert_manager_alb_id)                                              | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_prometheus_blackbox_exporter_alb_id"></a> [prometheus_blackbox_exporter_alb_id](#input_prometheus_blackbox_exporter_alb_id)                                  | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_prometheus_blackbox_exporter_ecs_task_def"></a> [prometheus_blackbox_exporter_ecs_task_def](#input_prometheus_blackbox_exporter_ecs_task_def)                | ecs task definition base encoded                                      | `string`       | n/a                         |   yes    |
| <a name="input_prometheus_blackbox_exporter_security_group_id"></a> [prometheus_blackbox_exporter_security_group_id](#input_prometheus_blackbox_exporter_security_group_id) | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_prometheus_cloudwatch_exporter_alb_id"></a> [prometheus_cloudwatch_exporter_alb_id](#input_prometheus_cloudwatch_exporter_alb_id)                            | n/a                                                                   | `string`       | n/a                         |   yes    |
| <a name="input_prometheus_cloudwatch_exporter_ecs_task_def"></a> [prometheus_cloudwatch_exporter_ecs_task_def](#input_prometheus_cloudwatch_exporter_ecs_task_def)          | ecs task definition base encoded                                      | `string`       | n/a                         |   yes    |
...
| <a name="input_prometheus_ecs_task_def"></a> [prometheus_ecs_task_def](#input_prometheus_ecs_task_def)                                                                      | ecs task definition base encoded                                      | `string`       | n/a                         |   yes    |
...
| <a name="input_prometheus_exporter_security_group_id"></a> [prometheus_exporter_security_group_id](#input_prometheus_exporter_security_group_id)                            | ## Security groups                                                    | `string`       | n/a                         |   yes    |
| <a name="input_prometheus_log_group"></a> [prometheus_log_group](#input_prometheus_log_group)                                                                               | Our prometheus log group                                              | `any`          | n/a                         |   yes    |
| <a name="input_prometheus_security_group_id"></a> [prometheus_security_group_id](#input_prometheus_security_group_id)                                                       | n/a                                                                   | `string`       | n/a                         |   yes    |
...
| <a name="input_sns_alert_notifications_arn"></a> [sns_alert_notifications_arn](#input_sns_alert_notifications_arn)                                                          | n/a                                                                   | `string`       | n/a                         |   yes    |
...
| <a name="input_user_service_alb_id"></a> [user_service_alb_id](#input_user_service_alb_id)                                                                                  | n/a                                                                   | `string`       | n/a                         |   yes    |
