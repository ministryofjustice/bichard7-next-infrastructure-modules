resource "aws_security_group" "s3_web_proxy_alb" {
...
resource "aws_security_group_rule" "allow_alb_https_egress_to_ecs" {
  ...
  security_group_id        = aws_security_group.s3_web_proxy_alb.id
  source_security_group_id = aws_security_group.s3_web_proxy_container.id
}
...
resource "aws_security_group_rule" "allow_https_ingress_on_container_from_alb" {
  ...
  security_group_id        = aws_security_group.s3_web_proxy_container.id
